<?php
	...
	if (isset($_REQUEST['member']))
	{
		...
		if (count($errors) == 0)
		{
			$query = "INSERT INTO member (mem_id,name,age,dob,package,mobileno,pay_id,trainer_id)VALUES('$mem_id','$name','$age','$dob','$package','$mobileno','$pay_id','$trainer_id')";
...
<label class="mt-3">BRANCH ID</label>
